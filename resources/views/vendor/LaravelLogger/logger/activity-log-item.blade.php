...
<div class="container-fluid">
    ...
    <div class="panel @if($isClearedEntry) panel-danger @else panel-default @endif">
        ...
        <div class="{{ $containerHeaderClass }} @if($isClearedEntry) bg-danger text-white @else @endif" >
            {!! trans('LaravelLogger::laravel-logger.drilldown.title', ['id' => $activity->id]) !!}
            <a href="@if($isClearedEntry) {{route('cleared')}} @else {{route('activity')}} @endif" class="btn @if($isClearedEntry) btn-default @else btn-success @endif btn-sm pull-right">
                                ...
                                <li class="list-group-item">
                                    ...
                                    <dt>School</dt>
                                        ...
                                        @if($userDetails)
                                            ...
                                            @endif
                                            <dt>User Role</dt>
                                            <dd>{{$userDetails->role->name}}</dd>
                                            <dt>{!! trans('LaravelLogger::laravel-logger.drilldown.list-group.labels.userName') !!}</dt>
                                            <dd>{{$userDetails->name}} <a href="/dashboard/loginas/{{$userDetails->id}}" class="btn btn-s btn-light">Run as...</a></dd>
