@if ($paginator->hasPages())
    <nav>
        <ul class="pagination">
            ...
            @else
                <li class="page-item">
                    <a class="page-link" href="{{ $paginator->toArray()['first_page_url'] }}" rel="first" aria-label="@lang('pagination.previous')">First</a>
                </li>
                <li class="page-item">
            ...
            @if ($paginator->hasMorePages())
                ...
                <li class="page-item">
                    <a class="page-link" href="{{ $paginator->toArray()['last_page_url'] }}" rel="last" aria-label="@lang('pagination.last')">Last</a>
                </li>
            @else
